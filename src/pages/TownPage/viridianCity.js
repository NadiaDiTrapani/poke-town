...
import map from '../../assets/images/ViridianCityCrop-icon.png'
import PokeCard from '../../components/PokeCard/pokeCard';
import Pokedex from 'pokedex-promise-v2';
import axios from 'axios';
import { useEffect, useState } from 'react';

function ViridianCityPage() {
    const P = new Pokedex();
    ...
    useEffect(() => {
        P.getLocationAreaByName("viridian-city-area")
            .then((response) => {
        ...
        <div className='town'>
            ...
            <div className='town__card-cont'>
                <div className='town__title-cont'>
                    <h1 className='town__title'>viridian city</h1>
                </div>
...
export default ViridianCityPage;
